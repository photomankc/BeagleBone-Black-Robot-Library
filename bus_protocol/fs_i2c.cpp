...
int FS_I2C::tx(int32_t reg, uint8_t* bytes, int count)
...
int FS_I2C::txByte(int32_t reg, uint8_t bt)
{
...
int FS_I2C::txWord(int32_t reg, uint16_t wd)
{
...
int FS_I2C::rx(int32_t reg, uint8_t* bytes)
{
